  ...
  return (
    <div className='product-form'>
      <div>
        ...
        <input type="text" onChange={fieldChangeHandler('title')} value={title} />
      </div>
      <div>
        <span className='label'>Price:</span>
        <input type="text" onChange={fieldChangeHandler('price')} value={price} />
      </div>
      <div>
        <span className='label'>Inventory:</span>
        <input type="text" onChange={fieldChangeHandler('inventory')} value={inventory} />
      </div>
    </div>
  )
